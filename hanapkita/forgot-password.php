...
<head>
<title>JobSeeker Reset Your Account Password | Hanap-Kita</title>
...
<input type="password" class="form-control" name="password" id="confirmpassword" required placeholder="Confirm Password">
     ...
     <div class="input-box" style="display: flex; justify-content: center; width: 100%; margin-bottom: 25px;">
    <input type="submit" value="Sign in" name="signin" class="signin-btn" style="width: 100%; padding: 15px 40px;">
</div>


<div class="login-social" style="margin-bottom: 20px;">
    <em>If you already have an Account? <a href="sign-in.php">SIGN IN NOW</a></em>
</div>
