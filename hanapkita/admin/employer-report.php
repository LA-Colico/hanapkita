        ...
        <main id="main-container">
            <div class="content main-content">
                ...
                <div class="page-header fade-in">
                    ...
                    <h1 class="page-title">Employer Between Dates Report</h1>
                    <p class="page-subtitle">Generate comprehensive reports of employer registrations within your specified date range</p>
                </div>
                ...
                <div class="stats-overview fade-in">
                    ...
                    $sql_recent = "SELECT COUNT(*) as count FROM tblemployers WHERE date(RegDtae) >= DATE_SUB(CURDATE(), INTERVAL 30 DAY)";
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-content">
                            <h3><?php echo number_format($active_employers); ?></h3>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-content">
                            <h3><?php echo number_format($recent_employers); ?></h3>
                            <p>Recent (30 Days)</p>
                        </div>
                    </div>
                    <div class="stat-card">
                        ...
                        <div class="stat-content">
                            <h3><?php echo number_format($inactive_employers); ?></h3>
                ...
                <div class="report-form-card fade-in">
                    <div class="form-header">
                        ...
                        <p class="form-description">Choose the start and end dates to generate your employer registration report</p>
                    </div>

                    <form method="post" name="bwdatesreport" action="employer-bwdates-reports-details.php" class="date-form">
                ...
                <div class="quick-links fade-in">
                    <div class="quick-links-header">
                        ...
                        <h3 class="quick-links-title">Related Actions</h3>
                    </div>
                    <div class="quick-links-grid">
                        <a href="employer-list.php" class="quick-link-btn">
                            <i class="fas fa-list"></i>
                            View All Employers
                        </a>
                        <a href="employer-search.php" class="quick-link-btn">
                            <i class="fas fa-search"></i>
                            Search Employers
                        </a>
                        <a href="all-listed-jobs.php" class="quick-link-btn">
                            <i class="fas fa-briefcase"></i>
                            View All Jobs
                        </a>
                        <a href="candidates-report.php" class="quick-link-btn">
                ...
                <div class="tips-card fade-in">
                    ...
                    <ul class="tips-list">
                        <li>
                            ...
                            The report will include all employers who registered between your selected dates
                        </li>
                        <li>
                            <i class="fas fa-check"></i>
                        ...
                        <li>
                            <i class="fas fa-check"></i>
                            The report includes company details, contact information, and registration status
                        </li>
                    </ul>
                </div>
            </div>
