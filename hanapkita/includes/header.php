      ...
      <div class="navigation-col">
        ...
        <nav class="navbar navbar-inverse">
          ...
          <div class="navbar-header">
            ...
            <a href="index.php" style="text-decoration: none;"><strong class="logo" style="color: red;">
              <img src="images/logoheader2.png" width="50%" height="55%"></strong> </a> 
      ...
      <div class="thumb">
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
            ...
            <li><a href="sign-up.php">Jobseekers</a></li>
