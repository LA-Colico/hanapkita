...
<head>
    ...
    <title>Hanap-Kita - About Us</title>
...
<body class="bg-gray-50 text-gray-900 font-sans">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <nav class="hidden md:flex space-x-8">
                    ...
                    <a href="about.php" class="text-primary font-medium border-b-2 border-primary pb-1">About Us</a>
    ...
    <section class="bg-gradient-to-br from-blue-50 to-indigo-100 py-16">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-5xl font-bold text-gray-900 mb-6">About Us</h1>
            <p class="text-xl text-gray-600">Discover who we are and what drives our mission</p>
        </div>
    </section>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-sm p-8 md:p-12">
                ...
                <div class="prose prose-lg max-w-none">
                    <h2 class="text-3xl font-bold text-center text-gray-900 mb-8"><?php echo ($row->PageTitle);?></h2>
