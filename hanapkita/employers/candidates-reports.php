...
<head>
  ...
  <title>Between Dates Report | Hanap-Kita</title>
  ...
  <div class="py-12 bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-10 text-center">
        <h1 class="text-3xl font-bold text-gray-900">Between Dates Report</h1>
        <p class="mt-2 text-lg text-gray-600">Generate reports for candidate applications between specific dates</p>
      </div>
      
      <!-- Report Form Card -->
      <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="border-b border-gray-100 bg-gradient-to-r from-primary-light to-primary px-6 py-4">
          <h2 class="text-xl font-semibold text-white">Between dates Report of Applied Candidates</h2>
        </div>
          ...
          <form action="candidates-bwdates-reports-details.php" method="post" enctype="multipart/form-data">
            <div class="space-y-6">
              ...
              <div>
                ...
                <input type="date" name="todate" id="todate" required="true" 
                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary sm:text-sm" />
              </div>
              ...
              <div class="pt-4">
                <button type="submit" name="submit" id="submit" 
                        class="inline-flex items-center justify-center w-full px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors">
      ...
      <div class="mt-12 grid md:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div class="w-12 h-12 flex items-center justify-center bg-primary-light bg-opacity-20 rounded-full mb-4">
            <i class="fas fa-calendar-alt text-primary text-xl"></i>
          </div>
          <h3 class="text-lg font-semibold mb-2">Date Range Analysis</h3>
          <p class="text-gray-600">View candidate applications received between specific dates to analyze hiring trends.</p>
        </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <h3 class="text-lg font-semibold mb-2">Comprehensive Data</h3>
          <p class="text-gray-600">Get detailed information about each applicant including contact details and application status.</p>
        </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <h3 class="text-lg font-semibold mb-2">Performance Tracking</h3>
          <p class="text-gray-600">Monitor recruitment performance and identify patterns in application volume over time.</p>
        </div>
      </div>
    </div>
  </div>
