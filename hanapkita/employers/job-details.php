...
<head>
  ...
  <title>Job Details | Hanap-Kita</title>
  ...
  <div class="py-12 bg-gray-50">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-10 text-center">
        ...
        <p class="mt-2 text-lg text-gray-600">View complete information about this job posting</p>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <!-- Job Header -->
        <div class="flex flex-col md:flex-row p-6 border-b border-gray-100">
          <div class="flex-shrink-0 mb-4 md:mb-0 md:mr-6">
            <div class="w-24 h-24 bg-gray-100 rounded-lg overflow-hidden flex items-center justify-center">
              <img src="employerslogo/<?php echo htmlentities($result->CompnayLogo);?>" alt="Company Logo" class="max-w-full max-h-full object-contain">
            </div>
          </div>
          
          <div class="flex-1">
            <h2 class="text-2xl font-bold text-gray-900 mb-2"><?php echo htmlentities($result->jobTitle);?></h2>
            
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
              <div class="flex items-center text-gray-700">
                <i class="fas fa-briefcase mr-2 text-primary"></i>
                <span>Experience: <?php echo htmlentities($result->experience);?></span>
              </div>
              <div class="flex items-center text-gray-700">
                <i class="fas fa-map-marker-alt mr-2 text-primary"></i>
                <span><?php echo htmlentities($result->jobLocation);?></span>
              </div>
              <div class="flex items-center text-gray-700">
                <i class="fas fa-calendar-alt mr-2 text-primary"></i>
                <span>Posted: <?php echo htmlentities($result->postinDate);?></span>
              </div>
            </div>
            ...
            <div class="flex flex-wrap items-center justify-between">
              <div class="flex items-center mb-2 md:mb-0">
                ...
                <span class="text-xl font-semibold text-gray-900">₱<?php echo htmlentities($result->salaryPackage);?></span>
              </div>
        ...
        <div class="p-6">
          <div class="mb-6">
            ...
            <div class="flex flex-wrap gap-2">
              <?php 
              $skills = explode(',', $result->skillsRequired);
              foreach($skills as $skill) {
                if(trim($skill) != '') {
                  echo '<span class="px-3 py-1 bg-gray-100 text-gray-800 rounded-full text-sm">' . trim($skill) . '</span>';
                }
              }
              ?>
            </div>
          ...
          <div class="border-t border-gray-100 pt-6">
            <a href="candidates-applied-job.php?jobid=<?php echo htmlentities($result->jobId);?>" 
              ...
              <i class="fas fa-users mr-2"></i> View Candidates Applied
            </a>
            
            <a href="edit-job.php?jobid=<?php echo htmlentities($result->jobId);?>" 
               class="inline-flex items-center px-6 py-3 ml-4 border border-gray-300 text-base font-medium rounded-md shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors">
